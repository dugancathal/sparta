...
describe TeachersController do
  ...
  let(:valid_attributes) { { "email" => "demo@example.com" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested teacher" do
        ...
        Teacher.any_instance.should_receive(:update).with({ "email" => "demo@example.com" })
        put :update, {:id => teacher.to_param, :teacher => { "email" => "demo@example.com" }}, valid_session
      end
